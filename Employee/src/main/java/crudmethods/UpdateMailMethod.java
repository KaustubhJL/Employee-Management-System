...
public class UpdateMailMethod {
	public static void updateMail (ArrayList<EmployeeConstructor>al, EmployeeConstructor em,String id, String mail) throws EmployeeNotFoundException,IdFormatWrongException{
		if (em == null) {
